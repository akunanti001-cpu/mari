...
?>
  ...
  <!-- glitch layers -->
  <text x="25" y="105" class="main glitch-cyan" transform="translate(-3,0)">BUG</text>
  <text x="25" y="105" class="main glitch-red" transform="translate(3,0)">BUG</text>

  <!-- main text -->
  <text x="25" y="105" class="main">BUG</text>

  <!-- glitch slices -->
  <rect x="35" y="42" width="240" height="8" fill="#00bcd4" opacity="0.12"/>
  <rect x="60" y="70" width="180" height="6" fill="#ff004c" opacity="0.12"/>
  <rect x="95" y="96" width="200" height="5" fill="#00bcd4" opacity="0.10"/>
